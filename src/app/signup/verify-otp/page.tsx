        ...
        <div className="bg-white rounded-md shadow gap-[19px] flex flex-col px-5 py-[30px] md:py-[35px] md:px-[50px]">
          <div className="flex flex-col">
            ...
            <div className="pt-[19px]">
              ...
              <p className="font-medium md:text-sm text-[12px] py-[1px] text-gray-900">
          ...
          <button
            ...
            className="w-full bg-[#2BABE2] hover:bg-[#2395C1] h-[52px] text-[16px] font-semibold text-white py-2 rounded-md transition cursor-pointer"
          >
